...
public abstract interface SgaResponseMessage {
    public static final String ELEMENT_FOUND = "here is your course";
    ...
    public static final String COMPLETE_ELEMENT_UPDATE = "all element information was updated good";
}
